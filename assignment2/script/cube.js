function main() {
    var canvas = document.getElementById("lightSource");
    ...
    gl.uniform3fv(uLightConstant, [1.0, 0.0, 1.0]);   // white color
    gl.uniform1f(uAmbientIntensity, 0.301);             // 40% intensity
        // Diffuse
    var uLightPosition = gl.getUniformLocation(shaderProgram, "uLightPosition");
    gl.uniform3fv(uLightPosition, [0.0, 0.0, 1.0]);
